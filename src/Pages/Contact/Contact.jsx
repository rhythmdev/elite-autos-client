            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="container px-6 py-12 mx-auto">
                    <div className="text-center ">
                        <p className="font-medium text-gradient-start dark:text-blue-400">Contact us</p>

                        <h1 className="mt-2 text-2xl font-semibold text-gradient-end md:text-3xl dark:text-white">We’d love to hear from you</h1>
                    ...
                    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
                        <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                            <span className="inline-block p-3 text-gradient-start rounded-lg bg-blue-100/80 dark:bg-gray-700">
                            ...
                            <p className="mt-2 text-sm text-gradient-start dark:text-blue-400">hello@eliteautos.com</p>
                        </div>
                        ...
                        <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-gradient-start dark:text-blue-400">100 Smith Street Collingwood VIC 3066 AU</p>
                        </div>
                        ...
                        <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-gradient-start dark:text-blue-400">+1 (555) 000-0000</p>
                        </div>
                    </div>
                </div>
            </section>
