            ...
            <div className="w-full h-56 sm:h-64 lg:h-[600px] xl:h-[600px] 2xl:h-[600px]">
                <Carousel>
                    <div className=" flex h-full items-center justify-center dark:bg-gray-700 dark:text-white relative">
                        <img src={bannerOne} alt="banner-1" className="w-full  bg-black opacity-60" />
                        <div className=" absolute">
                            ...
                            <Button className="mx-auto mt-5 bg-transparent border-2 border-x-gradient-start border-y-gradient-end text-slate-700 lg:text-xl font-semibold font-lobster hover:text-white">Explore More</Button>
                        </div>

                    </div>
                    <div className="flex h-full items-center justify-center dark:bg-gray-700 dark:text-white">
                        <img src={bannerTwo} alt="banner-2" className="w-full  bg-black opacity-60" />
                        <div className="absolute">
                            ...
                            <Button className="mx-auto mt-5 bg-transparent border-2 border-x-gradient-start border-y-gradient-end text-slate-700 lg:text-xl font-bold font-lobster hover-text-white ">Explore More</Button>
                        </div>


                    </div>
                    <div className="flex h-full items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white">
                        <img src={bannerThree} alt="banner-3" className="w-full  bg-black opacity-60" />
                        <div className="absolute">
                            ...
                            <Button className="mx-auto mt-5 bg-transparent border-2 border-x-gradient-start border-y-gradient-end text-slate-700 lg:text-xl font-semibold font-lobster:text-white">Explore More</Button>
                        </div>

                    </div>
                    <div className="flex h-full items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white">
                        <img src={bannerFour} alt="banner-4" className="w-full  bg-black opacity-60" />
                        <div className="absolute">
